...
function addToChat(s) {
  ...
  var currentDiv = document.getElementById("chatlog");
...
document.addEventListener('DOMContentLoaded', function () {
  console.log('hi');
  var form = document.getElementById('input-field-form');
...
var groq = new groq_sdk__WEBPACK_IMPORTED_MODULE_0__.Groq({
  apiKey: "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",
  dangerouslyAllowBrowser: true
});

// export
function messageGroq(_x) {
  return _messageGroq.apply(this, arguments);
} // export
function _messageGroq() {
  _messageGroq = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(content) {
    var _chatCompletion$choic;
    var chatCompletion, s;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          s = ((_chatCompletion$choic = chatCompletion.choices[0]) === null || _chatCompletion$choic === void 0 || (_chatCompletion$choic = _chatCompletion$choic.message) === null || _chatCompletion$choic === void 0 ? void 0 : _chatCompletion$choic.content) || "";
          addToChat(s);
        case 5:
        case "end":
...
function getGroqChatCompletion(_x2) {
  return _getGroqChatCompletion.apply(this, arguments);
} //==== MAIN ====//
...
function _getGroqChatCompletion() {
  _getGroqChatCompletion = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(content) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", groq.chat.completions.create({
            messages: [{
              role: "user",
              content: content
            }],
...
function findInputElements() {
  ...
  var textareaElements = documesnt.querySelectorAll('textarea');
  textareaElements.forEach(function (el) {
    if (el.id) {
      elements.push({
        id: el.id,
        tag: 'textarea',
...
function setValue(elementId, value) {
  ...
  if (element) {
    element.value = value;
    console.log("Value set for element ".concat(elementId, ": ").concat(value));
  } else {
    console.log("Element with ID ".concat(elementId, " not found"));
  }
}
...
function submitForm(formId) {
  ...
  if (form) {
    form.submit();
    console.log("Form with ID ".concat(formId, " submitted."));
  } else {
    console.log("Form with ID ".concat(formId, " not found."));
  }
}
...
function triggerDebugActions() {
  ...
  var elements = findInputElements();
...
document.addEventListener('DOMContentLoaded', function () {
  var debugBtn = document.getElementById('debug-button');
